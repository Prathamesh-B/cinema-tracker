                        ...
                        <div className="flex items-center mt-4 md:mt-0">
                            <div className="p-1.5 w-full sm:w-auto overflow-hidden bg-white rounded-lg dark:bg-gray-800 ">
                                <div className="space-y-2 sm:space-y-0 sm:flex sm:-mx-1">
                                    <Link to="/login" className="mx-1 px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                                        Login
                                    </Link>
                                    <Link to="/signup" className="mx-1 px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                                        Signup
                                    </Link>
                                </div>
                            </div>
